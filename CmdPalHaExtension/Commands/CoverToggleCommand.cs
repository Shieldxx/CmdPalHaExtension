...
internal sealed partial class CoverToggleCommand : InvokableCommand
{
    private readonly HaEntityState _entity;

    public CoverToggleCommand(HaEntityState entity)
    {
        _entity = entity;
        Name = entity.State == "open" ? "Close" : "Open";
    ...
    public override ICommandResult Invoke()
    {
        ...
        var service = _entity.State == "open" ? "close_cover" : "open_cover";
        _ = Task.Run(async () =>
        {
