...
internal sealed partial class ToggleEntityCommand : InvokableCommand
{
    private readonly HaEntityState _entity;
    private readonly string _domain;

    public ToggleEntityCommand(HaEntityState entity)
    {
        _entity = entity;
        _domain = entity.GetDomain();
        Name = entity.State == "on" ? "Turn Off" : "Turn On";
